...
const navigation = [
  ...
  { name: 'Quotes', href: '/quotes', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  ...
  { name: 'AI Activity', href: '/ai-activity', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile backdrop */}
      <div className="fixed inset-0 bg-black/50 z-40 lg:hidden" style={{ display: 'none' }} />

      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex flex-col bg-surface-950 border-r border-surface-800 transition-all duration-200 ease-in-out ${
          collapsed ? 'w-16' : 'w-60'
        }`}
      >
        {/* Logo */}
          ...
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            {!collapsed && (
              <div className="animate-fade-in">
                <h1 className="text-sm font-bold text-white whitespace-nowrap">Garco</h1>
